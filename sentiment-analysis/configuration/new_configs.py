...
# ./Data_to_preprocess/task1- SR/Matlab files/resultsSomtingFiles
    'WORD_EMBEDDINGS_PATH': "./3TASK/embeddings/GoogleNews-vectors-negative300.bin",
    'ALL_PREPROCESSED_DATA_PATH': "./Data_to_preprocess/Sentence_label_data/",# Data of interest with respective formats
